...
// Mirrored by drv/68k/mml_rate.h (generated by tools/gen-c-tables.mjs) and by
// PCM_GROUP in drv/tools/gen-mixer.mjs.
//
// The env override is for the rate sweeps under drv/, and it is read through a
// `typeof` guard because THIS MODULE RUNS IN THE BROWSER: live/index.html
// imports export-mmb.js, which imports this, and a bare `process.env` there is
// a ReferenceError at module load — the MMB export stops working, with nothing
