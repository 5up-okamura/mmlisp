...
experimental/dac-stream/  the output-centred DAC engine prototype — P1/P2 pass on
                      BlastEm, and a NOTIFIED cooperative BUSREQ transfer holds
                      §6.2 at 16 KB/s across the host's phase. Every
                      notification-free (HBlank/computed) transfer fails, on
                      protocol as well as timing, since the R3 gate fixes; see
